...
import { BarChart3, Bell, Cpu, Database, MapPin, Search, User } from 'lucide-react';
    ...
    <header className="bg-white/90 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto h-20 px-4 md:px-8 flex items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-slate-950 flex items-center justify-center shadow-lg shadow-slate-900/10 overflow-hidden">
            <img src="/logo_bpp.png" alt="Logo BPP" className="w-full h-full object-contain p-1.5" />
          </div>
          <div>
